...
from models.dual_ia3pool.dual_ia3poollayer import DualIA3PoolLayer, Linear


class DualIA3PoolModel(BaseTuner):
    """
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if isinstance(target, DualIA3PoolLayer):
            target.update_layer(
                adapter_name,
    ...
    def _set_adapter_layers(self, enabled=True):
        for module in self.model.modules():
            if isinstance(module, (DualIA3PoolLayer, ModulesToSaveWrapper)):
