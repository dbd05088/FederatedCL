...
class LlamaDecoderIA3PoolLayer(LlamaDecoderLayer):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.lang_prompt_ia3_pool_1 = CodaPrompt(config.prompt_top_k,4096+4096+11008,1024,pool_size=config.pool_size,n_tasks=4)
        self.lang_prompt_ia3_pool_2 = CodaPrompt(config.prompt_top_k,4096+4096+11008,1024,pool_size=config.pool_size,n_tasks=4)
        # 4096 + 4096 + 11008
        self.last_task_id = -1
...
class LlavaLlamaForCodaIA3DualCausalLM(LlamaDAPForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaConfig
