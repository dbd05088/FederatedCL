...
class LlamaDecoderIA3PoolLayer(LlamaDecoderLayer):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.lang_prompt_ia3_pool = Pool2(1,4096+4096+11008,1024,pool_size=config.pool_size,top_k=config.prompt_top_k)
        # 4096 + 4096 + 11008
...
class LlavaLlamaForL2PIA3CausalLM2(LlamaDAPForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaConfig
