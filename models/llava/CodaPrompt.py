...
class LlamaDecoderIA3PoolLayer(LlamaDecoderLayer):
    def __init__(self, config: LlamaConfig, layer_idx: int):
        ...
        self.lang_prompt_ia3_pool = CodaPrompt(config.prompt_top_k,4096+4096+11008,1024,pool_size=config.pool_size,n_tasks=4)
        # 4096 + 4096 + 11008
        self.last_task_id = -1
...
class LlavaLlamaForCodaIA3CausalLM(LlamaDAPForCausalLM, LlavaMetaForCausalLM):
    config_class = LlavaConfig
