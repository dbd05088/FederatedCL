...
from models.lae_ia3.lae_ia3_layer import LAEIA3Layer, Linear


class LAEIA3Model(BaseTuner):
    """
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if isinstance(target, LAEIA3Layer):
            target.update_layer(
                adapter_name,
    ...
    def _set_adapter_layers(self, enabled=True):
        for module in self.model.modules():
            if isinstance(module, (LAEIA3Layer, ModulesToSaveWrapper)):
