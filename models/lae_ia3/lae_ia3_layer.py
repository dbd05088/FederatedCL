...
class LAEIA3Layer(BaseTunerLayer):
...
class Linear(nn.Module, LAEIA3Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        LAEIA3Layer.__init__(self, base_layer, is_feedforward=is_feedforward)
    ...
    def forward(self, x: torch.Tensor, *args: Any, **kwargs: Any) -> torch.Tensor:
        ...
        if self.disable_adapters:
            ...
            for active_adapter in self.active_adapters:
                ...
                if self.active_lae_state == 'lora1':
                    ia3_scaling *= ia3_1.flatten()
                elif self.active_lae_state == 'lora2':
                    ia3_scaling *= ia3_2.flatten()
                elif self.active_lae_state == 'gate':
