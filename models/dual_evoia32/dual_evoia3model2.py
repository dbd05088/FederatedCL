...
from models.dual_evoia32.dual_evoia3layer2 import DualEVOIA3Layer2, Linear


class DualEVOIA3Model2(BaseTuner):
    """
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if isinstance(target, DualEVOIA3Layer2):
            target.update_layer(
                adapter_name,
    ...
    def _set_adapter_layers(self, enabled=True):
        for module in self.model.modules():
            if isinstance(module, (DualEVOIA3Layer2, ModulesToSaveWrapper)):
