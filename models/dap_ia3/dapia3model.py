...
from models.dap_ia3.dapia3layer import DAPIA3Layer, Linear


class DAPIA3Model(BaseTuner):
    """
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if isinstance(target, DAPIA3Layer):
            target.update_layer(
                adapter_name,
    ...
    def _set_adapter_layers(self, enabled=True):
        for module in self.model.modules():
            if isinstance(module, (DAPIA3Layer, ModulesToSaveWrapper)):
    ...
    def set_adapter(self, adapter_name: str | list[str]) -> None:
        ...
        """
        for module in self.model.modules():
            if isinstance(module, DAPIA3Layer):
                if module.merged:
