...
from models.lae_ia3_dual.dual_lae_ia3_layer import DualLAEIA3Layer, Linear


class DualLAEIA3Model(BaseTuner):
    """
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        if isinstance(target, DualLAEIA3Layer):
            target.update_layer(
                adapter_name,
    ...
    def _set_adapter_layers(self, enabled=True):
        for module in self.model.modules():
            if isinstance(module, (DualLAEIA3Layer, ModulesToSaveWrapper)):
